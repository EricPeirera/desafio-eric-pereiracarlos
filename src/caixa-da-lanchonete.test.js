...
describe('CaixaDaLanchonete', () => {
    ...
    test.each([
        ['dinheiro', 'R$ 19,47', ['cafe,2', 'sanduiche,1', 'queijo,4']],
        ['credito', 'R$ 21,12', ['cafe,2', 'sanduiche,1', 'queijo,4']],
        ['debito', 'R$ 20,50', ['cafe,2', 'sanduiche,1', 'queijo,4']],
    ])('compra de múltiplas quantidades em %p deve resultar em %p', validaTeste);
    ...
    test.each([
        ['com quantidade zero', 'dinheiro', 'Quantidade inválida!', ['sanduiche,0']],
        ['com um valor', 'credito', 'Item inválido!', ['5']],
        ['com código inexistente', 'debito', 'Item inválido!', ['arroz,1']],
